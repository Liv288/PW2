<footer class="footer">
    <div class="footer-content">
        ...
        <div class="social-buttons">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-twitch"
                viewBox="0 0 16 16">
                <path
        ...
        <div class="footer-columns">
            <div class="column">
                <h3>Empresa</h3>
                <p>Sobre a Nexus Four</p>
                <p>Equipe de Gerenciamento</p>
                <p>Responsibilidade Corporativa</p>
                <p>Oportunidades de Emprego</p>
            </div>

            <div class="column">
                <h3>Contato Nexus Four</h3>
            ...
            <div class="column">
                <h3>Bibliotecas de Mídias</h3>
                <p>Comunidade</p>
                <p>Fóruns de suporte</p>
                <p>Desenvolvedores</p>
                <p>Red Team</p>
            </div>
        ...
        <div class="links">
            ...
            <a href="#">Informação de marca registrada</a>
            <a href="#">Concorrência justa e aberta</a>
